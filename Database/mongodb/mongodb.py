...
from Mikubot import DB_NAME, LOGGER, MONGO_DB_URI

try:
    Mikubot_db_client = MongoClient(MONGO_DB_URI)
except PyMongoError as f:
    LOGGER.error(f"Error in Mongodb: {f}")
    exiter(1)
Mikubot_main_db = Mikubot_db_client[DB_NAME]
...
class MongoDB:
    ...
    def __init__(self, collection) -> None:
        self.collection = Mikubot_main_db[collection]
    ...
    @staticmethod
    def close():
        return Mikubot_db_client.close()
